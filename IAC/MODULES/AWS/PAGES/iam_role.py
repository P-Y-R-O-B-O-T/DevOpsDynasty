...
class MODULE:
    def __init__(self) -> None:
        self.MAP_VERSIONS_METHODS_CREATE = {
            "5.18.0": self.create_resource_5_18_0
        }
        self.MAP_VERSIONS_METHODS_MODIFY = {
            "5.18.0": self.modify_resource_5_18_0
        }

    def create_resource(self) -> None :
        self.MAP_VERSIONS_METHODS_CREATE[st.session_state[CONSTANTS.EXISTING_PROJECTS][st.session_state[CONSTANTS.SELECTED_PROJECT]][CONSTANTS.CONF_EXISTING_PROJECTS][CONSTANTS.PROVIDERS][MODULE_NAME]]()

    @st.dialog("IAM Role")
    def create_resource_5_18_0(self) -> None :
        pass
